  ...
  try {
    ...
    data.data.forEach(site => {
      ...
      detailsRow.innerHTML = `
        <td colspan="8" class="p-8 bg-gray-50">
    ...
    <div class="text-sm text-gray-700 leading-relaxed overflow-y-auto max-h-48 pr-2">
      ${site.description || "No description available."}
            ...
            <div class="bg-white p-4 shadow rounded-lg text-sm text-gray-700">
              ...
              <p class="mt-2">Please note that these results are updated monthly and may be subject to minor discrepancies. For the most accurate information, please log in directly to the respective platform.</p>
            </div>
          </div>
        </td>
      `;
